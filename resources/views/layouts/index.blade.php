                ...
                @else
                    @if (Auth::user()->role == 'admin')
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownPortfolio">
                                <a class="dropdown-item" href="{{ route('admin.index') }}"><em class="fa fa-desktop"></em> Backoffice</a>
                            ...
                            <div class="dropdown show-dropdown">
                                ...
                                <ul class="dropdown-menu" x-placement="top-start" style="position: absolute; transform: translate3d(-231px, -105px, 0px); top: 65px; left: -80px; will-change: transform;">
                                    <li class="button-container">
                                        ...
                                        <a class="btn btn-primary btn-block btn-fill" href="{{ route('interface.index') }}"><em class="fa fa-desktop"></em> Interface</a>
                                        <a class="btn btn-primary btn-block btn-fill" href="{{ route('product.page') }}"><em class="fa fa-product-hunt"></em> Porduits</a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownPortfolio">
                                <a class="dropdown-item" href="#"><em class="fa fa-edit"></em> Mes informations</a>
                                <a class="dropdown-item" href="{{ route('admin.index') }}"><em class="fa fa-tasks"></em> Mes commandes</a>
                                <a class="dropdown-item" href="{{ route('admin.index') }}"><em class="fa fa-envelope"></em> Services après vente</a>
                                <a class="dropdown-item" href="{{ route('logout') }}"
                                   onclick="event.preventDefault();
                                                         document.getElementById('logout-form').submit();">
                                    <em class="fa fa-power-off mr-1"></em> Se déconnecter
